"""
Django settings for planetmotors project.
...
ALLOWED_HOSTS = ['car-dealer-webapp-production.up.railway.app']
...
WSGI_APPLICATION = 'planetmotors.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'planetmotors/static'),
]
